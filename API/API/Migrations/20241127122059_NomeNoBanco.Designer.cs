...
namespace API.Migrations
{
    ...
    [Migration("20241127122059_NomeNoBanco")]
    partial class NomeNoBanco
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Models.Categoria", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CriadoEm = new DateTime(2024, 11, 28, 9, 20, 59, 194, DateTimeKind.Local).AddTicks(3597),
                            Nome = "Trabalho"
                        },
                        new
                        {
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 11, 29, 9, 20, 59, 194, DateTimeKind.Local).AddTicks(3612),
                            Nome = "Estudos"
                        },
                        new
                        {
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 11, 30, 9, 20, 59, 194, DateTimeKind.Local).AddTicks(3614),
                            Nome = "Lazer"
                        });
                });
            ...
            modelBuilder.Entity("API.Models.Tarefa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoriaId = "bfe4e7dc-81e4-4e47-a67b-d4fbf3e124bd",
                            CriadoEm = new DateTime(2024, 12, 4, 9, 20, 59, 194, DateTimeKind.Local).AddTicks(3774),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "6d091456-5a2f-4b5a-98fc-f1a3b50a627d",
                            CriadoEm = new DateTime(2024, 11, 30, 9, 20, 59, 194, DateTimeKind.Local).AddTicks(3779),
                        ...
                        new
                        {
                            ...
                            CategoriaId = "39be53a2-fc09-4b6a-bafa-18a6a23c8f6e",
                            CriadoEm = new DateTime(2024, 12, 11, 9, 20, 59, 194, DateTimeKind.Local).AddTicks(3781),
